    ...
    return(
        <>
            ...
            <div id="project">
                ...
                <iframe src="/Personal-Website-1/projects/cst489_Capstone_Proposal.pdf" width="100%" height="600px">
                    This browser does not support PDFs. Please download the PDF instead:
                    <a href="/Personal-Website-1/projects/cst489_Capstone_Proposal.pdf">Download PDF</a>
                </iframe>

                <p>Status Report</p>

                <iframe src="/Personal-Website-1/projects/cst489_Status_Update.pdf" width="100%" height="600px">
                    This browser does not support PDFs. Please download the PDF instead:
                    <a href="/Personal-Website-1/projects/cst489_Status_Update.pdf">Download PDF</a>
                </iframe>
            </div>
            <Footer/>
        </>
