    ...
    return(
        <>
            ...
            <div id="project">
                ...
                <iframe src="/projects/cst489_Capstone_Proposal.pdf" width="100%" height="600px">
                    This browser does not support PDFs. Please download the PDF instead:
                    <a href="/projects/cst489_Capstone_Proposal.pdf">Download PDF</a>
                </iframe>

                <p>Status Report</p>

                <iframe src="/projects/cst489_Status_Update.pdf" width="100%" height="600px">
                    This browser does not support PDFs. Please download the PDF instead:
                    <a href="/projects/cst489_Status_Update.pdf">Download PDF</a>
                </iframe>
            </div>
            <Footer/>
        </>
